...
public class MailUtility {
	...
	public String createBodyFromException(Exception e,String methodName) throws Exception {
		...
		String body = "Hello  "
				+ ",Please check the exception occurred in Application.Details are given below: Name : "
				+ "Book Store  " + ",IP Address : " + ip.getHostAddress()
				+ "  Method Name : " + methodName + " Exception: " + mailBody + ""
				+ " ";
		return body;
	}
